export const TestimonialsData = [
  ...
  {
    id: '2',
    userName: 'Kia Teck Chew',
    profilePic: '/static/images/avatar/3.jpg',
    date: '23 January 2019',
    comment:
      'My son Benjamin looks forward to every session with Hazirah. As he improves, we work closely with Alex and Haz to stretch the syllabus and each time, it’s such a joy to see Benjamin respond positively. As he enters Pri 1, we believe that together with Nurture Pods, he will continue to enjoy and grow to the best of his ability.',
  },
  {
    id: '3',
    userName: 'Phyllis Poon',
    profilePic: '/static/images/avatar/3.jpg',
